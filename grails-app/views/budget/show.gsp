...
<html>
    ...
    <body>
        ...
        <div id="show-budget" class="content scaffold-show" role="main">
            ...
            <f:display bean="budget" />
            <g:form resource="${this.budget}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.budget}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
